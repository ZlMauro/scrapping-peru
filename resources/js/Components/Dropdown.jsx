...
const DropdownLink = ({ href, method = "post", as = "a", children }) => {
    return (
        <Link
            ...
            method={method}
            as={as}
            className="block w-full px-4 py-2 text-left text-sm leading-5 text-gay-500 bg-none hover:bg-gray-300 focus:outline-none focus:bg-cyan-200 transition duration-150 ease-in-out"
        >
            {children}
        </Link>
    );
